...
const AddPropertyTransction = props => {
        ...
        <Col>
          <Card >
            ...
            <CardBody className="pt-5 ">
              ...
              <Button onClick={()=>props.history.push("../transactions")} className="btn btn-lg btn-danger"  color="danger">Cancel</Button>
...
export default withRouter(connect(mapStateToProps,{clearUnitError,fetchUnitList,fetchTenantList})(AddPropertyTransction))
